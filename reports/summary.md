...
Period: 2011-03 to 2026-03

Attribution target: BRK-B
Benchmark: SPY
Strategy: 12-month momentum, skip 1 month(s), long-only top 20%, equal-weighted
Universe: 51 static liquid US large-cap tickers after data-availability filtering
...
- CAPM: alpha 0.57%/month (t = 2.89)
- FF3: alpha 0.49%/month (t = 2.49)
- Carhart4: alpha 0.25%/month (t = 1.54)
- FF5: alpha 0.52%/month (t = 2.65)

Conclusion: the strategy's Carhart alpha does not survive the conventional |t| >= 2 hurdle.

## Attribution Target Snapshot

For BRK-B, the Carhart4 alpha is 0.14%/month
with t-stat 0.71; R2 is 0.47.
